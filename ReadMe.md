...
2. Функциональное тестирование выполняет задачу проверку работоспособности и выполнения заданных требований к продукту, установленных на этапе проектирования,
